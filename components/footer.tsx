  ...
  return (
    <footer className="bg-white border-t border-gray-100 py-16 md:py-20">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="space-y-3">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="block text-sm transition-colors duration-300 link-underline"
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm pt-2" style={{ color: 'var(--fg-muted)' }}>
                Lake Erie &bull; Pymatuning<br />
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4 text-xs" style={{ color: 'var(--fg-muted)' }}>
          <p>
